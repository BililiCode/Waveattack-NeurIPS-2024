...
schedule = {
    ...
    'test_model':'./experiments/resnet20_CIFAR10_Adapt_Blend_2023-09-07_22:48:42/ckpt_epoch_200.pth',
    # 'test_model':'./experiments/test/full_base_aug_seed=666.pt',

    'poison_data': './experiments/resnet20_CIFAR10_Adapt_Blend_2023-09-07_22:48:42/poison_data',
    # 'poison_data': './experiments/test/poison_data',

    'method': 'tsne',

    'save_dir': 'experiments',
    'experiment_name': 'visual_resnet20_CIFAR10_Adapt_Blend'
}

# Configure the attack scheme
Adapt_Blend = core.Adapt_Blend_Visual(
    dataset_name="cifar10",
    train_dataset=trainset,
    test_dataset=testset,
    model=core.models.resnet20(num_classes=10),
    y_target=0,
    poisoned_rate=0.03,      # follow the default configure in the original paper
    reg_rate = 0.03,
    schedule=schedule,
    seed=global_seed,
    deterministic=deterministic

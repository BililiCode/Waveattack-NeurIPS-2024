...
#     'experiment_name': 'resnet20_GTSRB_WaveAttack'
# }
#
# encoder_schedule = {
#     'secret_size': 32,
...
# WaveAttack = core.WaveAttack(
#     dataset_name="gtsrb",
#     train_dataset=trainset,
#     test_dataset=testset,
#     dis_model = core.models.ResNet(num=18, num_classes=43),
...
# )
#
# WaveAttack.train(schedule=schedule)
...
schedule = {
    ...
    'save_dir': 'experiments',
    'experiment_name': 'ResNeXt29_CIFAR10_WaveAttack'
}
...
WaveAttack = core.WaveAttack(
    ...
    train_dataset=trainset,
    test_dataset=testset,
    dis_model = core.models.ResNet(num=18, num_classes=10),
    model=core.models.ResNeXt29_2x64d(10),
    loss=nn.CrossEntropyLoss(),
    y_target=5,
    poisoned_rate=0.05,      # follow the default configure in the original paper
    reg_rate = 0.05,

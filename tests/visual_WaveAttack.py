...
schedule = {
    ...
    'test_model':'./experiments/train_poison_resnet18_CIFAR10_WaveAttack_2023-08-26_22:53:54/ckpt_epoch_200.pth',
    'test_netG':'./experiments/train_poison_resnet18_CIFAR10_WaveAttack_2023-08-26_22:53:54',

    'method':'tsne',

    'save_dir': 'experiments',
    'experiment_name': 'visual_resnet18_CIFAR10_WaveAttack'
}

# Configure the attack scheme
WaveAttack = core.WaveAttack_Visual(
    dataset_name="cifar10",
    train_dataset=trainset,
    test_dataset=testset,
    dis_model = core.models.ResNet(18, num_classes=10),
    model=core.models.ResNet(18, num_classes=10),
    y_target=1,
    poisoned_rate=0.003,      # follow the default configure in the original paper
    reg_rate = 0.003,
    schedule=schedule,
    seed=global_seed,
    deterministic=deterministic
